...
We did not run timings against the Brute Force or Divide and Conquer Algorithm because it simply could not calculate solutions in a reasonable time (less than 30 minutes) when working with $A>20$. Although this algorithm is guaranteed to derive the optimal answer, it cannot do so in a scalable manner.
