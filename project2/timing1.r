...
plot(y1 ~ x, data=df, type="p", pch=1, cex=1, col="blue", xlim=c(2000, 2200), ylim=c(0, 20), main="Problem 4 Coin Change Timing Plot", xlab="Amount of Change", ylab="Running Time (ms)")
