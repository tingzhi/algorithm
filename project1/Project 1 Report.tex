...
\textbf{1. Pseudo-Code}\\\\
\textbf{1.1 Enumeration Algorithm}\\
...
In this algorithm, since sum = sum(a[i:j]) costs $\Theta(n)$ because potentially this sum is a i to j loop. So the running-time complexity is\\
$T(n) = \Theta(n^3)$\\



\textbf{1.2 Better Enumeration Algorithm}\\
...
\textbf{1.3 Divide and Conquer Algorithm}\\
